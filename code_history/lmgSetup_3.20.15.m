...
if strfind(ls,'setup_parameters.mat')>0
    ...
    if isempty(javachk('desktop'))
        ...
        sampleinfo = inputdlg({ ...
            ...
            'Etch Fraction (0.0-1.0):' ...                 %4
            'Mesh Size (nm):' ...                          %5
            'Simulation Height (nm):' ...                  %6
            'Simulation Length (nm):'...                   %7
            'Aspect Ratio for 3D Simulation Depth:'...     %8
            'Number of Illumination Sources (1 or 2):'...  %9
            'Temporal Source Coherence? (0=no, 1=yes):'... %10
            'Total Illumination Power (mW/cm^2):'...       %11
            'Source 1 Wavelength (nm):'...                 %12
            'Source 1 Polarization (deg):'...              %13
            'Relative Intensity of Source 1:'...           %14
            'Source 2 Wavelength (nm):'...                 %15
            'Source 2 Polarization (deg):'}, ...           %16
        ...
        if str2num(sampleinfo{9})==2;
            ...
            parameters.pol2=str2num(sampleinfo{16});
    ...
    else % Command Prompt Setup for Non Graphical Mode
