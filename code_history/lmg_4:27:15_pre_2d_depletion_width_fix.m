    ...
    while total_cells_added < cells_per_iteration
        ...
        for ind1=1:size(coord_within_depletion_width,1)
            interface_points_within_depletion_width=interface_points_within_depletion_width+...
                circshift(interface_points,coord_within_depletion_width(ind1,:));
        end
        ...
        for ind1=1:size(coord_within_depletion_width,1)
            ...
            gen_within_depletion_width=gen_within_depletion_width+...
                circshift(gen_not_including_suface./(interface_points_within_depletion_width+(interface_points_within_depletion_width==0)),coord_within_depletion_width(ind1,:));
        ...
        cell_addition_probability=(1+((n0+p0)*power_in*gen_within_depletion_width...
            *tao+((power_in*gen_within_depletion_width*tao).^2)*ni^-2))...
